...
function Footer() {
  return (
    <div   data-scroll data-scroll-section data-scroll-speed="-0.3" className='w-full h-screen bg-white rounded-t-2xl flex gap-5 rounded-t-2xl'>
        <div className='w-1/2 px-20 py-20 flex flex-col justify-between '>
            <div className=''>
                <h1 className='font-["Founders_Grotesk_X-Condensed"] text-8xl font-semibold'>EYE-</h1>
                <h1 className='font-["Founders_Grotesk_X-Condensed"] text-8xl font-semibold '>OPENING</h1>
            </div>
            <div className='flex'>
        ...
        <div className='Links w-1/2 h-full py-20 flex flex-col justify-between'>
            <div className='w-full h-1/5'>
                <h1 className='font-["Founders_Grotesk_X-Condensed"] text-8xl font-semibold'>PRESENTATIONS</h1>

            </div>
            <div className='w-full h-1/5 mb-2 font-["Neue_Montreal"]'>
                {["S:","Instagram","Behance","Facebook","LinkedIn"].map((item,index)=>{
                    return <a className={`flex flex-col underline ${index==1 && 'mt-3'} ${index==0 && 'no-underline'}`} href="#">{item}</a>
                })}
            </div>
            <div className='w-full h-1/5 flex justify-between font-["Neue_Montreal"] mt-10'>
                <div className='w-1/2'>
                    {["L:","202-1965 W 4th AveVancouver, Canada","30 Chukarina StLviv, Ukraine"].map((item,index)=>{
                        return <a className={`flex flex-col underline pr-40 ${index==1 && 'my-3'} ${index==0 && 'no-underline'}`} href="#">{item}</a>
                    })}


                </div>
                <div className='w-1/2 pl-20 font-["Neue_Montreal"]'>
            ...
            <div className='w-full h-1/5 mt-14 font-["Neue_Montreal"] mt-10'>
                {["E:","hello@ochi.design"].map((item,index)=>{
                    return <a className={`flex flex-col underline ${index==1 && 'my-3'} ${index==0 && 'no-underline'}`} href="#">{item}</a>
                })}
            </div>
            <div className='w-full h-1/5 mt-16 text-zinc-400 flex justify-between font-["Neue_Montreal"]'>
                <div className='w-1/2 flex'>
                    <h4>&copy;ochi design 2024.</h4>
